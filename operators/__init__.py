...
- Φ (Phi)     — диалог с Эфосом, признание непознаваемого
...
```python
from operators import PhiRitual, __operators__
```

— вы не просто получаете класс, а вступаете в контакт с онтологическим примитивом, осознанно и с метаданными.
"""
