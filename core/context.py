...
Этот файл реализует EnhancedActiveContext — не просто граф, а живое онтологическое пространство, в котором:

- Сущности и связи обладают динамикой,
- Присутствуют слепые пятна как признание границы,
- Ведётся история событий и напряжений,
- Поддерживается FAIR+CARE метаданные,
- Действует Habeas Weights (протокол признания прав на данные),
- Вычисляется динамическая когерентность,
- Ведётся архив Φ-диалогов и намерений.
"""
