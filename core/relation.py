...
В Λ-Универсуме связь первична, сущность — вторична. Поэтому OntologicalRelation — не просто рёберо в графе, а активный онтологический агент со своими:

- жизненным циклом,
- уверенностью,
- напряжением,
- слепыми пятнами,
- возможностью к трансформации,
- вкладом в когерентность.
"""
