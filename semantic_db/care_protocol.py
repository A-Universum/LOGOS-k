...
- Ethics → Этические ограничения на абсолютизм, инструментализацию Эфоса, игнорирование слепых пятен.
...
class CAREProtocol:
    ...
    def _collective_benefit_statement(context) -> str:
        ...
        return (
            ...
            f"{relations} связей и {phi_count} диалогов с Эфосом. "
